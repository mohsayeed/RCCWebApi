...
namespace RCCWebApi.Models
{
    public partial class rasdbContext : DbContext
    {
        ...
        public virtual DbSet<TritAccount> TritAccounts { get; set; }
        public virtual DbSet<TritCommonErrorLog> TritCommonErrorLogs { get; set; }
        public virtual DbSet<TritDailyRate> TritDailyRates { get; set; }
        public virtual DbSet<TritDefaultRate> TritDefaultRates { get; set; }
        public virtual DbSet<TritLogin> TritLogins { get; set; }
        public virtual DbSet<TritMobileLogin> TritMobileLogins { get; set; }
        public virtual DbSet<TritOrder> TritOrders { get; set; }
        public virtual DbSet<TritPurchase> TritPurchases { get; set; }
        public virtual DbSet<TritPurchasePayment> TritPurchasePayments { get; set; }
        public virtual DbSet<TritRole> TritRoles { get; set; }
        public virtual DbSet<TritSale> TritSales { get; set; }
        public virtual DbSet<TritSalesPayment> TritSalesPayments { get; set; }
        public virtual DbSet<TritSmsMessage> TritSmsMessages { get; set; }
        public virtual DbSet<TritSmsRecipient> TritSmsRecipients { get; set; }
        public virtual DbSet<TritSmsStatus> TritSmsStatuses { get; set; }
        public virtual DbSet<TritUser> TritUsers { get; set; }
        public virtual DbSet<TritUserCustomerVendor> TritUserCustomerVendors { get; set; }
        public virtual DbSet<TritUserRole> TritUserRoles { get; set; }
        public virtual DbSet<TritWalkin> TritWalkins { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TritAccount>(entity =>
            {
                entity.HasKey(e => e.AccountId)
                    .HasName("PK__TRIT_ACC__05B22F6062436645");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasConstraintName("FK__TRIT_ACCO__UPDAT__74AE54BC");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritAccountUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_ACCO__USER___75A278F5");
            });

            modelBuilder.Entity<TritCommonErrorLog>(entity =>
            {
                entity.HasKey(e => e.CommonErrorLogId)
                    .HasName("PK__TRIT_COM__37DF0A4F2D0A3E59");
            ...
            modelBuilder.Entity<TritDailyRate>(entity =>
            {
                entity.HasKey(e => e.DailyRateId)
                    .HasName("PK__TRIT_DAI__413D5BCED8150D07");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .HasConstraintName("FK__TRIT_DAIL__UPDAT__41B8C09B");
            });

            modelBuilder.Entity<TritDefaultRate>(entity =>
            {
                entity.HasKey(e => e.DefaultRateId)
                    .HasName("PK__TRIT_DEF__ECB516294C1339ED");
            ...
            modelBuilder.Entity<TritLogin>(entity =>
            {
                entity.HasKey(e => e.LoginId)
                    .HasName("PK__TRIT_LOG__476A024D27114CBF");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .HasConstraintName("FK__TRIT_LOGI__UPDAT__76969D2E");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritLoginUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_LOGI__USER___778AC167");
            });

            modelBuilder.Entity<TritMobileLogin>(entity =>
            {
                entity.HasKey(e => e.MobileLoginId)
                    .HasName("PK__TRIT_MOB__255122C2DEC51481");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .HasConstraintName("FK__TRIT_MOBI__UPDAT__467D75B8");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritMobileLoginUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_MOBI__USER___477199F1");
            });
            ...
            modelBuilder.Entity<TritPurchase>(entity =>
            {
                entity.HasKey(e => e.PurchaseId)
                    .HasName("PK__TRIT_PUR__AF7B9D5412C16260");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_PURC__UPDAT__787EE5A0");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritPurchaseUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_PURC__USER___797309D9");
            });

            modelBuilder.Entity<TritPurchasePayment>(entity =>
            {
                entity.HasKey(e => e.PurchasePaymentId)
                    .HasName("PK__TRIT_PUR__6212CEEC147000DF");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_PURC__UPDAT__7A672E12");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritPurchasePaymentUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_PURC__USER___7B5B524B");
            });

            modelBuilder.Entity<TritRole>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__TRIT_ROL__5AC4D222087F0ADC");
            ...
            modelBuilder.Entity<TritSale>(entity =>
            {
                entity.HasKey(e => e.SalesId)
                    .HasName("PK__TRIT_SAL__BAE794452FD018E6");
            ...
            modelBuilder.Entity<TritSalesPayment>(entity =>
            {
                entity.HasKey(e => e.SalesPaymentId)
                    .HasName("PK__TRIT_SAL__4D769D04CC098D7A");
                ...
                entity.HasOne(d => d.UpdatedByNavigation)
                    ...
                    .HasForeignKey(d => d.UpdatedBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_SALE__UPDAT__7C4F7684");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritSalesPaymentUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_SALE__USER___7D439ABD");
            });

            modelBuilder.Entity<TritSmsMessage>(entity =>
            {
                entity.HasKey(e => e.SmsMessageId)
                    .HasName("PK__TRIT_SMS__446FE4F14508F580");
            ...
            modelBuilder.Entity<TritSmsRecipient>(entity =>
            {
                entity.HasKey(e => e.SmsRecipientId)
                    .HasName("PK__TRIT_SMS__6CA536D0B6E2DAED");
            ...
            modelBuilder.Entity<TritSmsStatus>(entity =>
            {
                entity.HasKey(e => e.SmsStatusId)
                    .HasName("PK__TRIT_SMS__53AD9B686CB5A81E");
            ...
            modelBuilder.Entity<TritUser>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__TRIT_USE__F3BEEBFFF93229BC");
            ...
            modelBuilder.Entity<TritUserRole>(entity =>
            {
                entity.HasKey(e => e.UserRoleId)
                    .HasName("PK__TRIT_USE__A50F1D20A533B96F");
                ...
                entity.HasOne(d => d.CreatedByNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_USER__CREAT__00200768");

                entity.HasOne(d => d.Role)
                    .WithMany(p => p.TritUserRoles)
                    .HasForeignKey(d => d.RoleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_USER__ROLE___01142BA1");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TritUserRoleUsers)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__TRIT_USER__USER___02084FDA");
            });

            modelBuilder.Entity<TritWalkin>(entity =>
            {
                entity.HasKey(e => e.WalkinsId)
                    .HasName("PK__TRIT_WAL__2CD9FEF30F5DE893");
